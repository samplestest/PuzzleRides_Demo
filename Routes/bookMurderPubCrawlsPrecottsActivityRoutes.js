...
const { BookMurderPubCrawlsPrescottActivityController: Controller } = require("../Controllers");
...
module.exports = [
    ...
    {
        method: "POST",
        path: "/admin/BookMurderPubCrawlsPrescottActivity",
        config: {
            handler: async function (request, h) {
                try {
                    ...
                    return await UniversalFunctions.sendSuccess(
                        null,
                        await Controller.addEditBookMurderPubCrawlsPrescottActivity(request.payload, userData)
                    )
                } catch (e) {
                    console.log(e);
            ...
            description: "Add Edit BookMurderPubCrawlsPrescottActivity API",
            auth: "AdminAuth",
            tags: ['api'],
            validate: {
        ...
        config: {
            handler: async function (request, h) {
                try {
                    return await UniversalFunctions.sendSuccess(
                        null,
                        await Controller.fetchBookMurderPubCrawlsPrescottActivity(request.query)
                    )
                } catch (e) {
                    console.log(e);
                    return await UniversalFunctions.sendError(e);
            ...
            description: "Fetch BookMurderPubCrawlsPrescottActivity API",
            tags: ['api'],
            validate: {
                query: Joi.object({
                    skip: Joi.number(),
